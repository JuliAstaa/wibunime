      ...
      <div className="p-4 m-auto bg-gray-950">
        <table>
          <tbody className="text-sm">
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Season</td>
              <td className="text-white">:</td>
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Duration</td>
              <td className="text-white">:</td>
              <td className="text-slate-300 capitalize">
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Total episodes</td>
              <td className="text-white">:</td>
              <td className="text-slate-300 capitalize">
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Year</td>
              <td className="text-white">:</td>
              <td className="text-slate-300 capitalize">
                {data.year ? data.year : "-"}
              </td>
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Studio</td>
              <td className="text-white">:</td>
              <td className="text-slate-300 capitalize">
                {studio ? studio : "-"}
              </td>
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Rating</td>
              <td className="text-white">:</td>
              <td className="text-slate-300 capitalize">
            ...
            <tr>
              <td className="text-slate-300 font-semibold">Aired</td>
              <td className="text-white">:</td>
              <td className="text-slate-300 capitalize">{data.aired.string}</td>
            </tr>
          </tbody>
        </table>
      </div>
