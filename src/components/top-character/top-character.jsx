...
const TopCharacter = async () => {
  ...
  return (
    <div>
      ...
      <div className="mt-2 w-full lg:border-l-2 lg:px-4 lg:border-slate-300 lg:dark:border-slate-700">
        {topCharacter.data.map((character) => {
          return (
            <div className="flex w-full h-auto gap-4  " key={character.mal_id}>
              <div className="flex items-center gap-4 border-b-[1px] border-slate-300  w-full h-full mb-4 py-2 dark:border-slate-700">
